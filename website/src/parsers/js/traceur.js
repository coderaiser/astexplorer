...
export default {
    ...
    parse(traceur, code, options) {
        const sourceFile = new traceur.syntax.SourceFile(FILENAME, code);
        const errorReporter = new traceur.util.ErrorReporter();
        ...
        const parser = new traceur.syntax.Parser(
            sourceFile,
            errorReporter,
        ...
        const ast = options.SourceType === 'Script' ?
            parser.parseScript() :
            parser.parseModule();
